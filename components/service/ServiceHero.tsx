      ...
      <Container as="div" className="relative py-24 md:py-36">
        ...
        <div className="mt-10">
          <MagneticButton>
            <Link
              href="/iletisim"
              className="inline-flex items-center gap-2 bg-accent px-6 py-3.5 text-sm font-medium text-accent-foreground transition-all hover:shadow-[0_0_40px_-5px_hsl(173_80%_40%_/_0.6)]"
            >
              {ctaText} <span>→</span>
            </Link>
          </MagneticButton>
