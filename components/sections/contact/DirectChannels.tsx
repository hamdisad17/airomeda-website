...
const CHANNELS = [
  {
    icon: '◉',
    label: 'WhatsApp',
    description: 'Hızlı sorular için direkt mesaj',
  ...
  },
  {
    icon: '◈',
    label: 'E-posta',
    description: 'Detaylı brief ve teknik sorular',
    href: 'mailto:hello@airomeda.com',
    cta: 'hello@airomeda.com',
  },
  {
    icon: '⬡',
    label: 'Brief PDF',
    description: 'Hazır brief şablonumuzu indirin',
  ...
  },
  {
    icon: '◧',
    label: 'Randevu',
    description: '30 dakikalık keşif görüşmesi',
