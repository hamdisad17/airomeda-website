...
excerpt: Incremental extraction of a 12-year-old monolithic core banking system into a modular, event-driven architecture — zero downtime, five times the transaction capacity.
metrics:
  ...
  - label: Zero-downtime migration
    value: "100%"
testimonial:
  quote: The Airomeda team truly thought alongside us on regulatory compliance. Every architectural decision we made became auditable and reversible.
  author: Serkan Doğan
  role: CTO, PayGate Bank
gallery: []
related_cases: []
---
