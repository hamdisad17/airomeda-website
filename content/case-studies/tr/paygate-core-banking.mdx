...
excerpt: 12 yıllık monolit core banking yazılımının etap etap modüler mimariye taşınması; sıfır kesinti, beş kat daha yüksek işlem kapasitesi.
metrics:
  - label: İşlem hızı artışı
    value: 5x
  - label: Operasyonel maliyet düşüşü
    value: "-38%"
  - label: Yeni ürün lansman süresi
    value: 6 hafta
  - label: Kesintisiz geçiş
    value: "100%"
testimonial:
  quote: Airomeda ekibi, regülasyona uyum konusunda gerçekten birlikte düşündü. Mimaride aldığımız her karar denetlenebilir ve geri dönebilir oldu.
  author: Serkan Doğan
  role: CTO, PayGate Bankası
gallery: []
related_cases: []
---
