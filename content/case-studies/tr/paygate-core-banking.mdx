---
title: PayGate Bankacılık Altyapısı Modernizasyonu
...
excerpt: 12 yıllık bankacılık altyapısının sıfır kesinti ile modern mimariye taşınması. İşlem kapasitesi 5× arttı, düzenleyici denetim ilk turda geçildi.
metrics:
  ...
  - label: Kesinti süresi
    value: "0"
  - label: Sistem yanıt hızı
    value: 142ms
testimonial:
  quote: Bankacılık altyapımızı 4 ayda sıfır kesinti ile modernize ettiler. Düzenleyici denetimi ilk turda geçtik.
  author: Murat Karaağaç
  role: Genel Müdür, PayGate
gallery: []
related_cases: []
---
