...
excerpt: Bir bankacılık projesinde BDDK ve MASAK uyumu için yapısal log şeması, değişmez log zinciri ve gerçek zamanlı anomali tespiti nasıl kuruldu.
...
Bir bankacılık projesinde BDDK denetimine 8 hafta kalan noktada kapsamlı bir log altyapısı eksikliğiyle karşılaştık. Bu yazı, sıfırdan kurduğumuz mimarinin teknik detaylarını aktarıyor.
