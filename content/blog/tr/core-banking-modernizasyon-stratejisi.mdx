...
excerpt: PayGate projesinde mainframe'den event-driven Kafka mikroservislerine geçerken öğrendiklerimiz. Strangler-fig, değişmez event log ve BDDK audit hazırlığı.
